            ...
            <form action="proses/update.php" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='email' value='".$row['email']."' class='form-control' placeholder='Masukkan Email'>";
                  ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control " name="level">
                    <option disabled="" selected="" value="<?= $row['id_user']?>"><?= $row['level']?></option>
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <textarea name='bio' class='form-control' placeholder='Masukkan Bio'>".$row['bio']."</textarea>";
                  ?>
                </div>                                            
              </div>
