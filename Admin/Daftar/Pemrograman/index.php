        ...
        <section class="section">
                ...
                <div class="card mb-0">
                  <div class="card-body">
                    <ul class="nav nav-pills">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="../Komik/index.php">Komik <span class="badge badge-white">
                        <?php 
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="index.php">Pemrograman <span class="badge badge-white">
                        <?php 
          ...
          <div class="section-body">
            <div class="row">
              <?php 
              include '../../../koneksi.php';
              $query = "SELECT * FROM buku WHERE jenis_buku='Pemrograman'";
              $exe = mysqli_query($conn,$query);
              $no=1;
