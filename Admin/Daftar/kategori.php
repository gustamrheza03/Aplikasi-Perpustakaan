...
$query2 = "SELECT * FROM buku WHERE id_kategori='$id_kategori' ORDER BY jenis_buku ASC";
$exe2 = mysqli_query($conn,$query2);
$query3 = "SELECT DISTINCT buku.jenis_buku, buku.id_kategori, kategori.nama_kategori FROM buku, kategori WHERE buku.id_kategori = kategori.id_kategori AND buku.id_kategori = '$id_kategori'";
