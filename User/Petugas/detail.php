                  ...
                  <form action="proses/update.php" method="post">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                        echo "
                        <textarea name='alamat' class='form-control' placeholder='Masukkan Alamat' disabled=''>".$row['alamat']."</textarea>";
                        ?>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label>Umur</label>
                        <input readonly="" type="text" name="umur" class="form-control" placeholder="Umur" disabled='' value=
                        "<?php 
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                        echo "
                        <input type='number' name='no_hp' value='".$row['no_hp']."' class='form-control' placeholder='Masukkan Nomor Telepon' disabled=''>";
                        ?>
                      </div>                      
                      <div class="form-group">
