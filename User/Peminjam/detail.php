      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="http://www.smkjakartapusat1.sch.id/Tentang-Kami/Profil-Sekolah.html" class="btn btn-primary btn-lg btn-block btn-icon-split">
                  ...
                  <form action="proses/update.php" method="post">
                    ...
                    <select name="nisn" id="nisn" class="form-control" onchange='changeValue(this.value)' required>
                      ...
                      <div class="form-group">
                        ...
                        <input type='text' name='nama' id='nama' value='".$row1['nama']."' class='form-control' placeholder='Masukkan Nama Lengkap'  disabled=''>";
                        ?>
                      </div>
                      <div class="form-group">
                        <label>Alamat</label>
                        <?php 
                        echo "
                        <textarea name='alamat' id='alamat' class='form-control' placeholder='Masukkan Alamat' disabled=''>".$row1['alamat']."</textarea>";
                        ?>
                      </div>
                      <div class="form-group">
                        ...
                        <?php 
                        echo "
                        <input type='text' name='asal_sekolah' id='asal_sekolah' value='".$row1['asal_sekolah']."' class='form-control' placeholder='Masukkan Asal Sekolah' disabled=''>";
                        ?>
                      </div>
                    </div>
                  </form>
