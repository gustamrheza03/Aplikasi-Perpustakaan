                  ...
                  <div class="form-group">
                    ...
                    <select name="username" id="username" class="form-control" onchange='changeValue(this.value)' required>
                      ...
                      while ($row = mysqli_fetch_array($result)) {  
                        ...
                        $jsArray .= "prdName['" . $row['username'] . "'] = {nama:'" . addslashes($row['nama']) . "',level:'".addslashes($row['level']). "',email:'".addslashes($row['email'])."',password:'".addslashes($row['password'])."'};\n";
                      }
                      ?>
                    </select>
                  </div>
...
<script type="text/javascript"> 
  ...
  function changeValue(username){
    document.getElementById('nama').value = prdName[username].nama;
