                  ...
                  <form action="proses/update.php" method="post">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type='text' name='judul' value='".$row['judul']."' class='form-control' placeholder='Masukkan Judul Buku' disabled=''>";
                        ?>
                      </div>
                      <div class="form-group">
                        ...
                        <?php 
                        echo "
                        <input type='text' name='pengarang' value='".$row['pengarang']."' class='form-control' placeholder='Masukkan Nama Pengarang' disabled=''>";
                        ?>
                      </div>
                      <div class="form-group">
                        ...
                        <?php 
                        echo "
                        <input type='text' name='penerbit' value='".$row['penerbit']."' class='form-control' placeholder='Masukkan Nama Penerbit' disabled=''>";
                        ?>
                      </div>
                      <div class="form-group">
                        <label>Jenis buku</label>
                        <select class="form-control " name="jenis_buku">
                          <option disabled="" selected="" value="<?= $row['id_buku']?>"><?= $row['jenis_buku']?></option>
                        </select>
                      </div>                      
                      <div class="form-group">
                        ...
                        <?php 
                        echo "
                        <input type='date' name='tahun_terbit' value='".$row['tahun_terbit']."' class='form-control' placeholder='Masukkan Tanggal Terbit' disabled=''>";
                        ?>
                      </div>
                    </div>
                  </form>
