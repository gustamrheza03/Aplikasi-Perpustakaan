      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="card card-statistic-1">
          ...
          <div class="card-wrap">
            ...
            <?php 
            $query = "SELECT COUNT(*) AS nama FROM user";
            $exe = mysqli_query($conn,$query);
            $bu = mysqli_fetch_array($exe);
            ?>
            <h3><?php echo $bu['nama']; ?></h3>
            <a href="../User/index.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>                  
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card card-statistic-2">
          ...
          <div class="card-wrap">
            ...
            <?php 
            $query = "SELECT COUNT(*) AS jumlah_buku FROM transaksi WHERE status='1'";
            $exe = mysqli_query($conn,$query);
            $bu = mysqli_fetch_array($exe);
            ?>
            <h3><?php echo $bu['jumlah_buku']; ?></h3>
            <a href="../Transaksi/data_peminjaman.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>                                    
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card card-statistic-2">
          ...
          <div class="card-wrap">
            ...
            <?php 
            $query = "SELECT COUNT(*) AS jumlah_buku FROM transaksi WHERE status='2'";
            $exe = mysqli_query($conn,$query);
            $bu = mysqli_fetch_array($exe);
            ?>
            <h3><?php echo $bu['jumlah_buku']; ?></h3>
            <a href="../transaksi/data_pengembalian.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>                                    
          </div>
        </div>
      </div>
    </div>
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: [
        <?php 
        $jumlah_novel = mysqli_query($conn,"SELECT * FROM buku WHERE id_kategori='1'");
        echo mysqli_num_rows($jumlah_novel);
        ?>, 
        <?php 
        $jumlah_komik = mysqli_query($conn,"SELECT * FROM buku WHERE id_kategori='3'");
        echo mysqli_num_rows($jumlah_komik);
        ?>,
        <?php 
        $jumlah_dongeng = mysqli_query($conn,"SELECT * FROM buku WHERE id_kategori='4'");
        echo mysqli_num_rows($jumlah_dongeng);
        ?>, 
        <?php 
        $jumlah_biografi = mysqli_query($conn,"SELECT * FROM buku WHERE id_kategori='2'");
        echo mysqli_num_rows($jumlah_biografi);
        ?>,
        <?php 
        $jumlah_pemrograman = mysqli_query($conn,"SELECT * FROM buku WHERE id_kategori='5'");
