    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="Admin/Stisla/assets/img/stisla-fill.svg" alt="logo" width="71" class="shadow-light rounded-circle mb-5 mt-2">
            <h5 class="text-dark font-weight-normal">Selamat datang di <span class="font-weight-bold">Perpustakaan</span></h5>
            ...
            <form method="POST" action="Proses/proses_login.php" class="needs-validation" novalidate="">
              ...
              <div class="mt-5 text-center">
                Tidak punya akun? <a href="register/registrasi.php">Daftar</a>
              </div>
            </form>
          </div>
        </div>
