            ...
            <form action="proses/update.php" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type='text' name='nisn' value='".$row['nisn']."' class='form-control' placeholder='Masukkan Nisn'>";
                  ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <?php 
                  echo "
                  <input type='text' name='asal_sekolah' value='".$row['asal_sekolah']."' class='form-control' placeholder='Masukkan Asal Sekolah'>";
                  ?>
                </div>
                <div class="form-group">
              ...
              <div class="card-footer text-right">
                <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini ?')" href="proses/delete.php?id_siswa=<?=$row['id_siswa'];?>" class="btn btn-danger">Delete</a>
...
<footer class="main-footer">
  <div class="footer-left">
    Copyright &copy; 2018 <div class="bullet"></div>  By <a href="http://www.smkjakartapusat1.sch.id/">Najwa</a>
  </div>
